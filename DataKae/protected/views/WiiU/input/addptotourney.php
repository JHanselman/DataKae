...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'dataProvider'=>$playerModel->tourneyParticipantsWiiU($model->tournamentId, false),
    'filter'=>$playerModel,
    'columns'=>array(
        'playerNickname',
        ),
...
<?php
echo CHtml::ajaxSubmitButton('Add selected player',Yii::app()->createUrl('WiiU/input/addPlayerToTourney',array('id' => $model->tournamentId)),
                    array(
                        'type'=>'POST',
                        'data'=> 'js:{"TournamentPlayers_WiiU": playerManager.selectedPlayer}',
                        'datatype'=> 'text',                      
...
<?php
echo CHtml::ajaxSubmitButton('Remove selected player',Yii::app()->createUrl('WiiU/input/removePlayerFromTourney',array('id' => $model->tournamentId)),
                    array(
                        'type'=>'POST',
                        'data'=> 'js:{"TournamentPlayers_WiiU": playerManager.selectedParticipant}',
                        'datatype'=> 'text',                      
                        'success'=>'function(data){$.fn.yiiGridView.update(\'possibleplayer-grid\');$.fn.yiiGridView.update(\'participant-grid\');}'      
                    ));
?>
