...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'dataProvider'=>$playerModel->tourneyParticipants3DS($model->tournamentId, false),
    'filter'=>$playerModel,
    'columns'=>array(
        'playerNickname',
        ),
...
<?php
echo CHtml::ajaxSubmitButton('Add selected player',Yii::app()->createUrl('3DS/input/addPlayerToTourney',array('id' => $model->tournamentId)),
                    array(
                        'type'=>'POST',
                        'data'=> 'js:{TournamentPlayers_3DS: playerManager.selectedPlayer}',
                        'datatype'=> 'text',                      
...
<?php
echo CHtml::ajaxSubmitButton('Remove selected player',Yii::app()->createUrl('3DS/input/removePlayerFromTourney',array('id' => $model->tournamentId)),
                    array(
                        'type'=>'POST',
                        'data'=> 'js:{"TournamentPlayers_3DS": playerManager.selectedParticipant}',
                        'datatype'=> 'text',                      
                        'success'=>'function(data){$.fn.yiiGridView.update(\'possibleplayer-grid\');$.fn.yiiGridView.update(\'participant-grid\');}'      
                    ));
?>
