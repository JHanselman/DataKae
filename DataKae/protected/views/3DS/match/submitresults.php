...
$stages=Stages_3DS::model()->findAll($stageCriteria);
$tournament = Tournament_3DS::model()->findByPk($match->tournamentId);

$this->breadcrumbs=array(
    'View Tourneys'=>array('//input/index'), $tournament->tournamentName =>array('//3DS/input/view', 'id' => $tournament->tournamentId),
    'Match',
);
