 ...
 *
 */
class PlayerVsCharacterLosses extends CActiveRecord
{
    /**
    ...
    {
        return 'PlayerVsCharacterLosses';
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('characterName',$this->characterName);
        $criteria->compare('player',$this->player);
        $criteria->order ='losses DESC';
