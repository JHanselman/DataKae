 ...
 */
class SubmitResultsForm_3DS extends CFormModel
{
    public $matchId;
    public $player_1;
    public $player_2;
    ...
    public function submitResults()
    {
        ...
        try
        {
            ...
            $tournament = Tournament_3DS::model()->findByPk($this->tournamentId);
    ...
    public function updateResults()
    {
        ...
        try
        {
            $newMatch=Match_3DS::model()->findbyPk($this->matchId);
            ...
            for ($i = 0; $i< $playedGames; $i++)
            {
                ...
                $game=Game_3DS::model()->findbyPk($this->games[$i]->gameId);
