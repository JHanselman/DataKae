 ...
 */
class Tournament_WiiU extends Tournament
{
    /**
        ...
        public function findByOrganizer($userId)
    {
        ...
        $criteria2->join='JOIN "WiiU_Tournament_Organizers" ds on ds."tournamentId" = t."tournamentId"';
    ...
    public function saveWithOrganizer()
    {
        ...
        try
        {
            ...
            $TO=new TournamentOrganizers_WiiU();
