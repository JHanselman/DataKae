...
{
    public $resultsFormModelName ='SubmitResultsForm_3DS';
    public $gamesFormModelName ='SubmitGamesForm_3DS';
    ...
    {
        $model=new searchForm_3DS('search');
    ...
    {
        $model=Match_3DS::model()->findByPk($id);
        if($model===null)
    ...
    {
        return new SubmitResultsForm_3DS();
    }
    function newSubmitGamesForm()
        {
        return new SubmitGamesForm_3DS();
    }
    function getGameModel()
        {
        return Game_3DS::model();
    }
