...
class Match extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            'sets'=>array(self::HAS_ONE, 'Set', 'matchId'),
    ...
    public function search()
    {
        ...
        $criteria->compare('date',$this->matchDate,true);
        $criteria->compare('type',$this->matchType,true);
        $criteria->compare('rulesetId',$this->rulesetId,true);
